...
class ResponseGenerator:
    ...
    def _handle_placement(self, program: str = None, specialization: str = None) -> tuple:
        ...
        response = (
            ...
            "VNIT has a strong placement record across all branches.\n\n"
            "**Top Recruiters:**\n"
            "• Amazon, Microsoft, Google, Goldman Sachs\n"
            "• TCS, Infosys, Wipro, Accenture\n"
            "• L&T, Tata Steel, and other core engineering companies\n\n"
            "**Typical Packages:**\n"
            "• **Highest package**: around 40-50 LPA (top offers, mainly CSE)\n"
            "• **Average package**: around 12-15 LPA\n"
            "• **Core branches**: 6-10 LPA average\n\n"
            "**Support Provided:**\n"
            "• Pre-placement training, mock interviews, and aptitude preparation\n"
            "• Regular internship drives with performance-based PPO offers\n"
            "• Many students also secure research internships and higher-study "
            "admits (MS/PhD) abroad\n\n"
            "_Note: Package figures vary each year. For the latest official "
            "statistics, check the Training & Placement section on the VNIT "
            "website (vnit.ac.in)._"
        )
        suggestions = [
